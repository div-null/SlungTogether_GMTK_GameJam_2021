...
public class Web : MonoBehaviour
{
    ...
    void Start()
    {
        spider1 = transform.parent.Find("ball1");
        spider2 = transform.parent.Find("ball2");
        AdjustScale();
    }
    ...
    {
        float angle = Vector3.SignedAngle(Vector3.up, (spider2.position - spider1.position).normalized, Vector3.forward);
